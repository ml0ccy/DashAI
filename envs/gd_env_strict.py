...
class GeometryDashLiveEnv(gym.Env):
    ...
    def __init__(
        ...
        capture,
        render_mode=None,
        attempt_keyword="ATTEMPT",
        template_threshold=0.9,
        confirm_frames=3,
        percent_threshold=0.88,
        percent_bonus=0.0,
        survival_multiplier_on_percent=1.0,
        death_cooldown=2.0,
        ...
        death_penalty_min=15.0,
        death_penalty_slope=2.0,
        death_penalty_cap=30.0
    ):
        super().__init__()
        self.capture_cfg = capture
        self.render_mode = render_mode
        self.attempt_keyword = attempt_keyword.upper()
        ...
        self.percent_bonus = float(percent_bonus)
        self.survival_multiplier_on_percent = float(survival_multiplier_on_percent)
        self.percent_templates = {}
        self.percent_sequence = [10, 20, 30, 40]
        self._percent_index = 0
        ...
        self._episode_start_time = self._last_reward_time
    ...
    def reset(self, *, seed=None, options=None):
        ...
        self._last_reward_time = time.time()
        self._episode_start_time = self._last_reward_time
        # Сохраняем поведение как в исходнике:
        self._last_death_time = -1e9
        self._post_restart_mute_until = -1e9
    ...
    def step(self, action):
        ...
        if not hasattr(self, "_death_gate_until"):
        ...
        if terminated:
            ...
            print(f"✅ Шаг {self.steps} → reward = {reward:.4f}")
        ...
        info = {
            ...
            "death_gate_left": max(0.0, (getattr(self, "_death_gate_until", -1e9) - time.time())),
